...
### ℹ️ About Page
![About](client/public/screenshots/about.png)

### 🔐 Login & Register
![Login/Register](client/public/screenshots/lr.png)

### 🧭 Navigation
![Navbar](client/public/screenshots/nav1.png)
![Navbar Variant](client/public/screenshots/nav2.png)

### 📋 Recipe List
![Recipe List](client/public/screenshots/recipelist.png)

### 📖 Recipe Details
![Recipe Details](client/public/screenshots/recipedetails.png)

### ❤️ Favorites
![Favorites](client/public/screenshots/fav.png)

### 👨‍🍳 User Recipes (My Recipes)
![User Recipes](client/public/screenshots/userrecipe.png)

### 📁 Folder structure
![Extra Screen 1](client/public/screenshots/file1.png)
![Extra Screen 2](client/public/screenshots/file2.png)
